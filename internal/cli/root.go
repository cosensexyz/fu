...
func NewRootCmd() *cobra.Command {
	...
	root.AddCommand(newListCmd(app), newShowCmd(app), newStatusCmd(app), newAgentCmd(app), newOutdatedCmd(app), newUpdateCmd(app), newRestoreCmd(app), newRevertCmd(app), newCommitCmd(app), newLogCmd(app))
